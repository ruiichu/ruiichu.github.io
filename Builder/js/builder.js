        ...
        */
        makeDraggable: function() {
            ...
            $('#elements li, #templates li').each(function(){
                ...
                $(this).draggable({
                    helper: function() {
                        return $('<div style="height: 100px; width: 300px; background: #F9FAFA; box-shadow: 5px 5px 1px rgba(0,0,0,0.1); text-align: center; line-height: 100px; font-size: 28px; color: #222"><span class="fui-list"></span></div>');
                    },
                    revert: 'invalid',
                    appendTo: 'body',
    ...
    module.exports.Element = function (el) {
        ...
        this.setOpen = function() {
            ...
            if( $(this.element).closest('body').width() !== $(this.element).width() ) {
                ...
                $(this.element).css({'outline': '2px solid #404040', 'cursor': 'pointer'});
            
            } else {
                
                $(this.element).css({'outline': '2px solid #404040', 'outline-offset':'-3px',  'cursor': 'pointer'});
        ...
        this.activate = function() {
            ...
            $(this.element).on('mouseenter', function() {
                ...
                if( $(this).closest('body').width() !== $(this).width() ) {
                    ...
                    $(this).css({'outline': '2px solid #404040', 'cursor': 'pointer'});
                            
                } else {
                    
                    $(this).css({'outline': '2px solid #404040', 'outline-offset': '-3px', 'cursor': 'pointer'});
...
(function () {
    ...
    module.exports.editableItems = {
            ...
            'nav a, a.edit': ['font-family', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],

            'span.sub-heading-small': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'span.sub-heading-big': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],

            'h6': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'h5': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'h4': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'h3': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'h2': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'h1': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'p': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],
            'a': ['font-family', 'text-align', 'color', 'font-size', 'letter-spacing', 'font-style', 'text-transform'],

            'a.btn, button.btn': ['border-radius', 'border', 'border-color', 'font-size', 'text-transform', 'background-color'],

            'img': ['border-radius', 'opacity', 'width', 'height'],
            ...
            '.hero-bg': ['background-image', 'background-color', 'opacity'],
            '.bg-white, .bg-dark': ['background-image', 'background-color', 'opacity'],
            '.bg-gray, .bg-blue, .bg-red, .bg-green, .bg-orange': ['background-image', 'background-color', 'opacity'],
        ...
        module.exports.editableItemOptions = {
            ...
            '.hero-bg : opacity': ['1', '.9', '.8', '.7', '.6', '.5', '.4', '.3', '.2', '.1'],
            '.bg-white, .bg-dark : opacity': ['1', '.9', '.8', '.7', '.6', '.5', '.4', '.3', '.2', '.1'],
            '.bg-gray, .bg-blue, .bg-red, .bg-green, .bg-orange : opacity': ['1', '.9', '.8', '.7', '.6', '.5', '.4', '.3', '.2', '.1'],

            'a.btn, button.btn : border-radius': ['0px', '1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'a.btn, button.btn : border': ['0px', '1px solid', '2px solid', '3px solid', '4px solid', '5px solid'],
            'a.btn, button.btn : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],

            'img : opacity': ['1', '.9', '.8', '.7', '.6', '.5', '.4', '.3', '.2', '.1'],
            
            'h1 : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'h1 : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'h1 : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'h1 : text-align': ['left', 'center', 'right'],
            'h1 : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'h2 : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'h2 : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'h2 : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'h2 : text-align': ['left', 'center', 'right'],
            'h2 : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'h3 : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'h3 : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'h3 : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'h3 : text-align': ['left', 'center', 'right'],
            'h3 : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'h4 : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'h4 : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'h4 : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'h4 : text-align': ['left', 'center', 'right'],
            'h4 : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'h5 : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'h5 : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'h5 : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'h5 : text-align': ['left', 'center', 'right'],
            'h5 : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'h6 : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'h6 : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'h6 : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'h6 : text-align': ['left', 'center', 'right'],
            'h6 : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'p : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'p : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'p : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'p : text-align': ['left', 'center', 'right'],
            'p : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'a : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'a : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'a : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'a : text-align': ['left', 'center', 'right'],
            'a : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'span.sub-heading-small : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'span.sub-heading-small : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'span.sub-heading-small : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'span.sub-heading-small : text-align': ['left', 'center', 'right'],
            'span.sub-heading-small : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'span.sub-heading-big : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'span.sub-heading-big : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'span.sub-heading-big : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'span.sub-heading-big : text-align': ['left', 'center', 'right'],
            'span.sub-heading-big : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona'],

            'nav a, a.edit : letter-spacing': ['1px', '2px', '3px', '4px', '5px', '6px', '7px', '8px', '9px', '10px'],
            'nav a, a.edit : font-style': ['normal', 'italic', 'oblique', 'initial'],
            'nav a, a.edit : text-transform': ['none', 'uppercase', 'lowercase', 'capitalize'],
            'nav a, a.edit : font-family': ['default', 'Lato', 'Helvetica', 'Bebas Neue', 'Times New Roman', 'Arial', 'Petrona']
        },
    
        module.exports.editableContent = ['.editContent', '.navbar a', 'button', 'a', 'a.btn', '.footer a:not(.fa)', '.tableWrapper', 'h1'],
        ...
        */
        resetElement: function() {
            ...
            if( $(styleeditor.activeElement.element).closest('body').width() !== $(styleeditor.activeElement.element).width() ) {
                ...
                $(styleeditor.activeElement.element).attr('style', '').css({'outline': '2px solid #404040', 'cursor': 'pointer'});

            } else {

                $(styleeditor.activeElement.element).attr('style', '').css({'outline': '2px solid #404040', 'outline-offset':'-3px', 'cursor': 'pointer'});
